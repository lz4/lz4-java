...
/**
 * Stream decoder for the LZ4 compression format, unsafe implementation.
 */
public class LZ4JavaUnsafeInputStream extends LZ4InputStream {

  public LZ4JavaUnsafeInputStream(InputStream is) throws IOException {
    super(is);
  }
  ...
  protected void uncompress() {
    ...
    while (sOff < srcEnd) {
      ...
      // matchs
      final int matchDec = readShortLittleEndian(compressed, sOff);
      sOff += 2;
      ...
      wildIncrementalCopy(uncompressed, matchOff, dOff, matchCopyEnd);
      dOff = matchCopyEnd;
